...
<body>
    ...
    <main>
        <div id="question">
            ...
            <p>Créer trois variables lastnames, firstname et age et les initialiser avec les valeurs de votre choix. Attention age est de type entier. Afficher leur contenu.</p>
        </div>
        <hr>
